...
training_set = Dataset(img_train, lb_train, models.densenet121(pretrained=True))
training_generator = data.DataLoader(training_set, **params)

validation_set = Dataset(img_val, lb_val, models.densenet121(pretrained=True))
validation_generator = data.DataLoader(validation_set, **params)

test_set = Dataset(img_test, lb_test, models.densenet121(pretrained=True))
...
pd.DataFrame(roc).to_csv('roc_densenet121_normalized.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_densenet121_normalized.csv')
pd.DataFrame(specificity).to_csv('specificity_densenet121_normalized.csv')
pd.DataFrame(accuracy).to_csv('accuracy_densenet121_normalized.csv')