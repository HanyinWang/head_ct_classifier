...
pd.DataFrame(roc).to_csv('roc_densenet201_normalized.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_densenet201_normalized.csv')
pd.DataFrame(specificity).to_csv('specificity_densenet201_normalized.csv')
pd.DataFrame(accuracy).to_csv('accuracy_densenet201_normalized.csv')