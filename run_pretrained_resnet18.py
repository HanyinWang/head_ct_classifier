...
pd.DataFrame(roc).to_csv('roc_resnet18.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_resnet18.csv')
pd.DataFrame(specificity).to_csv('specificity_resnet18.csv')
pd.DataFrame(accuracy).to_csv('accuracy_resnet18.csv')