...
pd.DataFrame(roc).to_csv('roc_resnet34_fine_tune.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_resnet34_fine_tune.csv')
pd.DataFrame(specificity).to_csv('specificity_resnet34_fine_tune.csv')
pd.DataFrame(accuracy).to_csv('accuracy_resnet34_fine_tune.csv')