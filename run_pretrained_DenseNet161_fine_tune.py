...
pd.DataFrame(roc).to_csv('roc_densenet161_fine_tune.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_densenet161_fine_tune.csv')
pd.DataFrame(specificity).to_csv('specificity_densenet161_fine_tune.csv')
pd.DataFrame(accuracy).to_csv('accuracy_densenet161_fine_tune.csv')