...
pd.DataFrame(roc).to_csv('roc_resnet34_normalize.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_resnet34_normalize.csv')
pd.DataFrame(specificity).to_csv('specificity_resnet34_normalize.csv')
pd.DataFrame(accuracy).to_csv('accuracy_resnet34_normalize.csv')