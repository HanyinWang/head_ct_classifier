...
pd.DataFrame(roc).to_csv('roc_vgg16_fine_tune.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_vgg16_fine_tune.csv')
pd.DataFrame(specificity).to_csv('specificity_vgg16_fine_tune.csv')
pd.DataFrame(accuracy).to_csv('accuracy_vgg16_fine_tune.csv')