...
pd.DataFrame(roc).to_csv('roc_densenet121_fine_tune.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_densenet121_fine_tune.csv')
pd.DataFrame(specificity).to_csv('specificity_densenet121_fine_tune.csv')
pd.DataFrame(accuracy).to_csv('accuracy_densenet121_fine_tune.csv')