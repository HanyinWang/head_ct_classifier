...
pd.DataFrame(roc).to_csv('roc_densenet169_fine_tune.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_densenet169_fine_tune.csv')
pd.DataFrame(specificity).to_csv('specificity_densenet169_fine_tune.csv')
pd.DataFrame(accuracy).to_csv('accuracy_densenet169_fine_tune.csv')