...
pd.DataFrame(roc).to_csv('roc_resnet152_normalize.csv')
pd.DataFrame(sensitivity).to_csv('sensitivity_resnet152_normalize.csv')
pd.DataFrame(specificity).to_csv('specificity_resnet152_normalize.csv')
pd.DataFrame(accuracy).to_csv('accuracy_resnet152_normalize.csv')