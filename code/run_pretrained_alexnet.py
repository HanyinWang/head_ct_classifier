...
pd.DataFrame(roc).to_csv(output_dir + 'roc_alexnet_nomalized.csv')
pd.DataFrame(sensitivity).to_csv(output_dir + 'sensitivity_alexnet_nomalized.csv')
pd.DataFrame(specificity).to_csv(output_dir + 'specificity_alexnet_nomalized.csv')
pd.DataFrame(accuracy).to_csv(output_dir + 'accuracy_alexnet_nomalized.csv')
