...
model.classifier = nn.Linear(1664, 14)
...
pd.DataFrame(roc).to_csv(output_dir + 'roc_densenet169_fine_tune.csv')
pd.DataFrame(sensitivity).to_csv(output_dir + 'sensitivity_densenet169_fine_tune.csv')
pd.DataFrame(specificity).to_csv(output_dir + 'specificity_densenet169_fine_tune.csv')
pd.DataFrame(accuracy).to_csv(output_dir + 'accuracy_densenet169_fine_tune.csv')
