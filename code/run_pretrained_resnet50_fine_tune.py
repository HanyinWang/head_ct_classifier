...
pd.DataFrame(roc).to_csv(output_dir + 'roc_resnet50_fine_tune.csv')
pd.DataFrame(sensitivity).to_csv(output_dir + 'sensitivity_resnet50_fine_tune.csv')
pd.DataFrame(specificity).to_csv(output_dir + 'specificity_resnet50_fine_tune.csv')
pd.DataFrame(accuracy).to_csv(output_dir + 'accuracy_resnet50_fine_tune.csv')
