...
model.classifier = nn.Linear(2208, 14)
...
pd.DataFrame(roc).to_csv(output_dir + 'roc_densenet161_fine_tune.csv')
pd.DataFrame(sensitivity).to_csv(output_dir + 'sensitivity_densenet161_fine_tune.csv')
pd.DataFrame(specificity).to_csv(output_dir + 'specificity_densenet161_fine_tune.csv')
pd.DataFrame(accuracy).to_csv(output_dir + 'accuracy_densenet161_fine_tune.csv')
