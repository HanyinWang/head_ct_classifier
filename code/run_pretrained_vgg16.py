...
pd.DataFrame(roc).to_csv(output_dir + 'roc_vgg16_normalize.csv')
pd.DataFrame(sensitivity).to_csv(output_dir + 'sensitivity_vgg16_normalize.csv')
pd.DataFrame(specificity).to_csv(output_dir + 'specificity_vgg16_normalize.csv')
pd.DataFrame(accuracy).to_csv(output_dir + 'accuracy_vgg16_normalize.csv')
